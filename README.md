...
│   ├── day3.py             # Operators and Conditionals
...
*   **day3.py**: Learning about **Operators** (math, comparison, and logical) and **Conditionals** (if, elif, else). How your code makes decisions.
